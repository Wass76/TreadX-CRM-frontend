                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', marginBottom: '12px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#6b7280' }}>
                          ...
                          <span style={{ fontSize: '14px' }}>{lead.businessEmail}</span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#6b7280' }}>
                          <Phone className="h-4 w-4" />
                          <span style={{ fontSize: '14px' }}>{lead.phoneNumber}</span>
                        </div>
        ...
        {pagination.totalPages > 1 && (
          <div style={{
            ...
            <div style={{ color: '#6b7280', fontSize: '14px' }}>
              Showing {pagination.page * pagination.size + 1} to {Math.min((pagination.page + 1) * pagination.size, pagination.totalElements)} of {pagination.totalElements} leads
            </div>
